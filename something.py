...
from Transformer.data.data import PrepareDataset
import torch
import pandas as pd
...
graph = GraphFeatures(adj_path = "Transformer/adj.npz",device='mps')
...
g = MAE_Mamba(graph=graph,N=307,T=3,hno=8).to("mps")
a = g(compound,.5)
print(a[2])